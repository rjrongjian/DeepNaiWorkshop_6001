    ...
    public class MailTool
    {
        ...
        public string SmtpHost
        {
            get
            {
                ...
                {
                    _SmtpHost = SystemConfig.MAIL_STMP_HOST;
                }
                return _SmtpHost;
            }
        }
        ...
        public int SmtpPort
        {
            get
            {
                if (_SmtpPort == -1)
                {
                    if (!int.TryParse(SystemConfig.MAIL_STMP_PORT, out _SmtpPort))
                    {
                        _SmtpPort = 25;
                    }
                }
        ...
        public string FromEmailAddress
        {
            get
            {
                ...
                {
                    _FromEmailAddress = SystemConfig.FROM_MAIL;
                }
        ...
        public string FormEmailPassword
        {
            get
            {
                ...
                {
                    _FormEmailPassword = SystemConfig.MAIL_FROM_PWD;
                }
        ...
        public void Send()
        {
            ...
            mm.From = new MailAddress(this.FromEmailAddress, SystemConfig.MAIL_FROM_MAIL_NAME, Encoding.UTF8);
